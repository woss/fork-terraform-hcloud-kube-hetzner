...
- Applied `calico_values` as a K3s-only Kustomization patch instead of uploading and then ignoring it, with plan-time rejection of malformed Kubernetes patch documents. RKE2 continues to use its bundled Calico chart (#2265; thanks @beslovas).
